...
class Sample:
    ...
    safety_label: Optional[str] = None # Label for safety check
    refusal_label: Optional[str] = None # Label for refusal check
    partialrollout: bool = False # Whether the sample is partialrollout sample
    pre_rep_length: int = 0
