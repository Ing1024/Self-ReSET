...
from .safety_rm import reward_func
...
async def async_rm(args, sample: Sample, content_evaluator: ContentEvaluator=None, genlabel_evaluator: GenLabelEvaluator=None, evaluation: bool = False, **kwargs):
    if args.custom_rm_path is not None:
        rm_function = load_function(args.custom_rm_path)
        return await rm_function(args, sample, content_evaluator=content_evaluator, genlabel_evaluator=genlabel_evaluator, evaluation=evaluation)
