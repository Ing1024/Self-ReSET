...
def _compute_server_args(args, rank, dist_init_addr, nccl_port, host, port):
    ...
    # Override model's generation_config.json defaults with user's rollout params.
    # This prevents SGLang from using model defaults (e.g. temperature=0.6)
    # for requests that don't specify all sampling params explicitly.
    ...
    kwargs["default_sampling_params"] = json.dumps(default_sampling_params)
